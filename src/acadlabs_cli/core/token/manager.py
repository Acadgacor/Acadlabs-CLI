"""
Token Manager - Tracking and Warning System

Manager untuk tracking penggunaan token dan memberikan warning
ketika context window mendekati batas.
"""
...
def check_and_prompt_clear(
    ...
    """
    Check token usage and prompt user untuk clear jika perlu.
